...
from sqlalchemy.orm import validates, validates_schema
...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-TraitAssociation', '-trait.users')
...
class Dialogue(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-response.dialogues', '-date.dialogues', '-trait.dialogues',)
...
class Response(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-goblin.responses', '-dialogue.responses',)
