...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        dialogues_2 = {
            ...
            'dialogue10': Dialogue(date_part=2, date_id=date1.id, trait_id=trait10.id, description="You say yes before you check your calendar. Shoot, you are supposesd to go on a date with Poorg. Oh well!"),
        }

        db.session.add_all(dialogues_1.values(), dialogues_1.values())
        db.session.commit()
